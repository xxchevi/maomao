...
INSERT INTO "new_offline_tasks" ("characterId", "completedAt", "createdAt", "duration", "expReward", "id", "itemRewards", "progress", "startedAt", "status", "targetId", "type", "updatedAt") SELECT "characterId", "completedAt", "createdAt", "duration", "expReward", "id", "itemRewards", "progress", "startedAt", "status", "targetId", "type", "updatedAt" FROM "offline_tasks";
